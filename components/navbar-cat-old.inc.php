...
<?php 
  // Get category Comments Count
   ...
   $all_comments = get_comments($comment_args);//Get all comments

  foreach ($all_comments as $comment) {

    $post_id = $comment->comment_post_ID;//Get post ID of comment

    if (! in_category('Old Kingdom', $post_id)) {
      continue;
    }
...
<div class="col-md-6 mb-4">
 <div class="row">
   <div class="col-md-6 ">
     <div class="card mb-4">
       <div class="card-body">
       Articles count:<?php echo $posts_count; ?>
       </div>
     </div>
   </div>
   <div class="col-md-6">
     ...
     <div class="card mb-4">
       ...
       comments Count:<?php echo $comments_count; ?> 
       </div>
     </div>
  ...
  <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active">
        <img class="d-block w-100" src="<?php echo get_template_directory_uri() . '/img/images/beautiful-egypt-10.jpg' ?>" alt="First slide">
      </div>
      <!--/First slide-->
      <!--Second slide-->
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo get_template_directory_uri() . '/img/images/beautiful-egypt-20.jpg' ?>" alt="Second slide">
      </div>
      <!--/Second slide-->
      <!--Third slide-->
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo get_template_directory_uri() . '/img/images/paramid-3.jpg' ?>" alt="Third slide">
      </div>
      <!--/Third slide-->
    </div>
    <!--/.Slides-->
